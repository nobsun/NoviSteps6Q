...
solve :: Solver
solve = \ case
    xys -> case groupBy ((==) `on` head) $ sort xys of
        [[p1,p2],[p3]] -> case zipWith subtract p1 p2 !! 1 of
            d -> case p3 of
                [x,y] -> bool [x,y+d] [x,y-d] (y == p2 !! 1)
                _ -> invalid
        [[p1],[p2,p3]] -> case zipWith subtract p2 p3 !! 1 of
            d -> case p1 of
                [x,y] -> bool [x,y+d] [x,y-d] (y == p3 !! 1)
                _ -> invalid
        _ -> invalid
